...
@st.cache_resource
def load_model():
    with open('/home/mokshith/burnout_project/burnout_model.pkl', 'rb') as f:
        model = pickle.load(f)
    with open('/home/mokshith/burnout_project/feature_names.pkl', 'rb') as f:
...
if page == "Prediction":
    ...
    # Make prediction
    if st.button("Predict Burnout Risk", key="predict_btn"):
